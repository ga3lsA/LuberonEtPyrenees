  ...
  houses: {
    ...
    gordes: {
      ...
      description: [
        ...
        "Rénovée en février 2023, elle est entièrement équipée et dispose de tout le confort : 2 chambres, cuisine équipée avec bar, salle de bain, lave-vaisselle, machine Nespresso, télévision, wifi très haut débit (fibre) et système de son.",
      ...
      amenities: [
        "2 chambres", "Piscine partagée 17 x 9 m", "Cuisine équipée + bar",
    ...
    marquixanes: {
      ...
      description: [
        ...
        "Elle dispose de 3 chambres, d'une salle d'eau avec douche, de 2 toilettes et d'une pièce à vivre entièrement équipée. Elle peut accueillir jusqu'à 6 personnes.",
      ...
      amenities: [
        "3 chambres (6 personnes)", "80 m² sur 2 étages", "Poutres apparentes",
